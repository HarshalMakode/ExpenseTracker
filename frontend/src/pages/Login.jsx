...
import { Wallet, Eye, EyeOff, Sun, Moon, Monitor } from "lucide-react";
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button className="text-xs text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors duration-150">
                    Forgot password?
                  </button>
                </div>
